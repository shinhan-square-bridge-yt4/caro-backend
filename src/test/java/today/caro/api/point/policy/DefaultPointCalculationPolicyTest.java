...
class DefaultPointCalculationPolicyTest {

    private final DefaultPointCalculationPolicy policy = new DefaultPointCalculationPolicy();

    @Test
    @DisplayName("주행 거리 1km당 1pt를 계산한다")
    void calculate_shouldReturn1PointPerKm() {
        // given
    ...
    void calculate_shouldTruncateDecimalPoints() {
        ...
        // then
        assertThat(points).isEqualTo(15); // 15.99 * 1 = 15.99 -> 15
    }
